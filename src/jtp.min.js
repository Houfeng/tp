...
return d(c);};if(typeof window!=="undefined"&&window.document){a.queryElement=function(c){return window.document.getElementById(c);};a.element=function(f,h){f=(typeof f==="string")?a.queryElement(f):f;
if(!f){return;}if(!f.jtp){var d=f.getAttribute("data-link");d=d?a.queryElement(d):f;var g=f.nodeName==="SCRIPT";var c=g?f:d;var e=g?d:f;f.jtp={exec:a.compile(b.inTransferred(c.innerHTML),h),bind:function(i){e.innerHTML=f.jtp.exec(i);
},append:function(i){e.innerHTML+=f.jtp.exec(i);}};f.innerHTML="";}return f.jtp;};}})((function(){var a=(typeof exports==="undefined")?{}:exports;if(typeof define==="function"&&define.amd){define("jtp",[],function(){return a;
});}if(typeof window!=="undefined"){window.jtp=a;}return a;})());