...
},append:function(e){c.innerHTML+=c.jtp.exec(e);}};c.innerHTML="";}return c.jtp;});})((function(){var a=(typeof exports==="undefined")?{}:exports;if(typeof window!=="undefined"){window.jtp=a;
}if(typeof define==="function"&&define.amd){define("jtp",[],function(){return a;});}return a;})());