...
this.jtp={};(function(a){var b={outTransferred:function(c){c=c.replace(new RegExp("\\{1}","gim"),"\\\\");c=c.replace(new RegExp("\r{1}","gim"),"");c=c.replace(new RegExp("\n{1}","gim"),"\\n");
...
},append:function(e){c.innerHTML+=c.jtp.exec(e);}};c.innerHTML="";}return c.jtp;});})(typeof exports==="undefined"?jtp:exports);